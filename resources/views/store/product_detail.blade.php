    ...
    <div class="col-md-6">
      <div class="product-block">
        ...
        <div class="product-info panel panel-body">
          ...
          @endif
          <span>
            <a class="btn btn-primary" href="{{ route('cart-add',$product->slug) }}"><i class="fa fa-cart-plus"></i> Agregar</a>            
          </span>
          <span>
            <a class="btn btn-info" href="{{URL::previous()}}"><i class="fa fa-chevron-circle-left"></i> Regresar</a>
          </span>
        </div>
      </div>
    </div>
