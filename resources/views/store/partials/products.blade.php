{{-- Aqui se forma la parte de productos de la pagina principal --}}
<div class="row">
      ...
      <div class="thumbnail center-block" style="height: 480px">
        ...
        <div class="caption" style="height: 100pxx">
          ...
          <div class="text-center">
            <a class="btn btn-primary" href="{{ route('cart-add',$product->slug) }}"><i class="fa fa-cart-plus"></i> <spam class="hidden-xs hidden-sm">Agregar</spam></a>
            <a class="btn btn-warning" href="{{ route('product-datail', $product->slug) }}"><i class="fa fa-chevron-circle-right"></i> <spam class="hidden-xs hidden-sm"> Detalle </spam> </a>
          </div>
        </div>
      </div>
    </div>
